...
ALTER TABLE users ADD CONSTRAINT users_ibfk_4 FOREIGN KEY (guild) REFERENCES guilds (id) DEFERRABLE INITIALLY DEFERRED;
CREATE INDEX ON users (guild);
ALTER TABLE users ADD CONSTRAINT users_ibfk_5 FOREIGN KEY (guild_rank) REFERENCES guild_ranks (id) DEFERRABLE INITIALLY DEFERRED;
CREATE INDEX ON users (guild_rank);
ALTER TABLE users ADD CONSTRAINT users_ibfk_6 FOREIGN KEY ("order") REFERENCES orders (id) DEFERRABLE INITIALLY DEFERRED;
CREATE INDEX ON users ("order");
ALTER TABLE users ADD CONSTRAINT users_ibfk_7 FOREIGN KEY (order_rank) REFERENCES order_ranks (id) DEFERRABLE INITIALLY DEFERRED;
