...
CREATE TABLE `items` (
  ...
  `type` enum('item','weapon','armor','helmet','potion','material','charter','intimacy_boost') NOT NULL DEFAULT 'item',
...
CREATE TABLE `item_sets` (
  ...
  `stat` enum('damage','armor','hitpoints') NOT NULL,
...
CREATE TABLE `skills` (
  ...
  `stat` enum('hitpoints','damage','armor') DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `style` varchar(15) NOT NULL DEFAULT 'default',
  `gender` enum('male','female') NOT NULL DEFAULT 'male',
  `banned` int(1) NOT NULL DEFAULT '0',
  `life` int(2) NOT NULL DEFAULT '60',
  `max_life` int(2) NOT NULL DEFAULT '60',
  ...
  CONSTRAINT `users_ibfk_4` FOREIGN KEY (`castle`) REFERENCES `castles` (`id`),
  CONSTRAINT `users_ibfk_5` FOREIGN KEY (`house`) REFERENCES `houses` (`id`),
  CONSTRAINT `users_ibfk_6` FOREIGN KEY (`guild`) REFERENCES `guilds` (`id`),
  CONSTRAINT `users_ibfk_7` FOREIGN KEY (`guild_rank`) REFERENCES `guild_ranks` (`id`),
  CONSTRAINT `users_ibfk_8` FOREIGN KEY (`order`) REFERENCES `orders` (`id`),
  CONSTRAINT `users_ibfk_9` FOREIGN KEY (`order_rank`) REFERENCES `order_ranks` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
