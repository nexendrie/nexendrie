...
INSERT INTO adventure_npcs VALUES
...
INSERT INTO items VALUES
  ...
  (26,'Vandrákův plášť','Potrhaný, lehký, starý plášť. Poskytuje velmi slabou ochranu',39,6,'armor',1),
...
INSERT INTO job_messages VALUES
  (1,1,TRUE,'Ulovil jsi a prodal 1 rybu.'),
  (2,1,FALSE,'Nepodařilo se ti nic ulovit.'),
  (3,1,FALSE,'Někdo ti ukradl chycenou rybu.'),
  (4,2,TRUE,'Vytěžil jsi 1 nerost.'),
  (5,2,FALSE,'Nic jsi nenašel.'),
  (6,3,TRUE,'Svěřené ovci se nic nestalo.'),
  (7,3,TRUE,'Svěřené krávě se nic nestalo.'),
  (8,3,FALSE,'Svěřená ovce se zaběhla.'),
  (9,3,FALSE,'Svěřená kráva se zaběhla.'),
  (10,4,TRUE,'Během tvé služby se nic nestalo.'),
  (11,4,TRUE,'Chytil jsi 1 zloděje.'),
  (12,4,FALSE,'Unikl ti zloděj.'),
  (13,4,FALSE,'Zranili tě protestující občaně.'),
  (14,5,TRUE,'Napsal si zápis bez jedniné chyby.'),
  (15,5,TRUE,'Přepsal si 1 kapitolu knihy.'),
  (16,5,TRUE,'Napsal si zápis z městské rady.'),
  (17,5,FALSE,'Rozlil se ti inkoust.'),
  (18,5,FALSE,'Udělal jsi v zápisu spostu chyb.'),
  (19,2,FALSE,'Praštil jsi se do hlavy.'),
  (20,4,TRUE,'Uklidnil jsi rozzuřený dav.'),
  (21,6,TRUE,'Podařilo se ti prodat zboží.'),
  (22,6,FALSE,'Na cestě do sousedního města tě přepadli lupiči.'),
  (23,6,FALSE,'Tvé zboží nechtěl nikdo koupit.');
...
INSERT INTO jobs VALUES
  ...
  (6,'Kupec','Kupec nakupuje zboží a následně jej jinde za vyšší cenu prodává.','Nakup nějaké zboží a pokus se jej prodat v sousedním městě.',0,8,120,100,6,1),(7,'Bankovní úředník','Banka Žajských potřebuje posily do místní pobočky. Nejvíce jsou potřeba úředníci na příjem a výdej hotovosti. Požadují se zkušenosti s obchodní činností.','Musíš obsluhovat klienty přicházející do banky. Aby sis zasloužil %reward%, musíš zvládnout alespoň %count% hodin.',20,220,60,100,6,2),
...
INSERT INTO mount_types VALUES
...
INSERT INTO order_ranks VALUES
  (1,'zbrojnoš',5,65),
  (2,'rytíř',5,90),
  (3,'mistr',10,125),
  (4,'velmistr',10,150);
...
INSERT INTO towns VALUES
  (1,'Velehrad','Starobylé hlavní město',1429779664,0,5000,FALSE),
  (2,'Myhr','Největší město na severovýchodě',1429779664,1,5000,FALSE),
  (3,'Světlohvozd','Malá vesnice ve středu země',1429779664,0,5000,FALSE),
  (4,'Bělehrad','Starobylé město na jihu země. Kdysi hlavní město (polo)samostatného knížectví, dnes královské a korunovační město',1429779664,0,5000,FALSE),
  (5,'Lípa','Vesnička na jihu země',1429779664,0,5000,TRUE),
  (6,'Žalecký Brod','Větší vesnice na východě země',1429779664,2,5000,FALSE),
  (7,'Dazluk','Přístavní město na západě',1429779664,0,5000,TRUE),
  (8,'Bílé Louky','Větší vesnice na jihu',1429779664,0,5000,TRUE),
  (9,'Vrchní Lhota','Vesnička na severovýchodě země',1447601504,1,1000,FALSE),
  (10,'Velké Běliny','Větší vesnice na jihu země',1455361687,4,5000,FALSE),
  (11,'Roden','Vesnice na západě země',1463914056,0,5000,TRUE);

INSERT INTO users VALUES
  (0,'system','Vladěna','$2y$10$SKkWGjWJBlDDZcviLt0SXu5fNEaxsRAXlP82.nLZfq9gWN7n.qKe2','admin@localhost',1429779664,1479045692,NULL,NULL,0,FALSE,'blue-sky','female',FALSE,60,60,560132,1,NULL,1,NULL,0,NULL,NULL,NULL,NULL),
  (1,'admin','Trimadyl z Myhru','$2y$10$SKkWGjWJBlDDZcviLt0SXu5fNEaxsRAXlP82.nLZfq9gWN7n.qKe2','jakub.konecny2@centrum.cz',1429779664,1494598141,NULL,1455366455,1,TRUE,'dark-sky','male',FALSE,90,90,23354,2,NULL,2,NULL,0,NULL,NULL,1,4);
