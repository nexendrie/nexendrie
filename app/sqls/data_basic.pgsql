...
INSERT INTO job_messages ("job", "success", "message") VALUES
  ...
  (4,TRUE,'Chytil jsi 1 zloděje.'),
  (4,FALSE,'Unikl ti zloděj.'),
  (4,FALSE,'Zranili tě protestující občaně.'),
  (5,TRUE,'Napsal si zápis bez jedniné chyby.'),
  (5,TRUE,'Přepsal si 1 kapitolu knihy.'),
  (5,TRUE,'Napsal si zápis z městské rady.'),
  (5,FALSE,'Rozlil se ti inkoust.'),
  (5,FALSE,'Udělal jsi v zápisu spostu chyb.'),
  (2,FALSE,'Praštil jsi se do hlavy.'),
  (4,TRUE,'Uklidnil jsi rozzuřený dav.'),
...
INSERT INTO jobs ("name", "description", "help", "count", "award", "shift", "level", "needed_skill", "needed_skill_level") VALUES
  ...
  ('Horník','Horník v podzemí těží nerosty.','Běž hledat nerosty. Musíš jich najít aspoň %count%, abys dostal %reward%. Jestli to nezvládneš, tak si mě nepřej!',20,80,50,50,4,0),
...
INSERT INTO users ("username", "publicname", "password", "email", "joined", "last_active", "last_prayer", "last_transfer", "group", "infomails", "style", "gender", "banned", "life", "max_life", "money", "town", "monastery", "castle", "house", "prayers", "guild", "guild_rank", "order", "order_rank") VALUES
  ('system','Vladěna','$2y$10$SKkWGjWJBlDDZcviLt0SXu5fNEaxsRAXlP82.nLZfq9gWN7n.qKe2','admin@localhost',1429779664,1479045692,NULL,NULL,0,FALSE,'blue-sky','female',FALSE,60,60,560132,1,NULL,1,NULL,0,NULL,NULL,NULL,NULL),
  ('admin','Trimadyl z Myhru','$2y$10$SKkWGjWJBlDDZcviLt0SXu5fNEaxsRAXlP82.nLZfq9gWN7n.qKe2','jakub.konecny2@centrum.cz',1429779664,1494598141,NULL,1455366455,1,TRUE,'dark-sky','male',FALSE,90,90,23354,2,NULL,2,NULL,0,NULL,NULL,1,4);
