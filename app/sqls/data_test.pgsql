...
INSERT INTO users ("username", "publicname", "password", "email", "joined", "last_active", "last_prayer", "last_transfer", "group", "infomails", "style", "gender", "banned", "life", "money", "town", "monastery", "castle", "house", "prayers", "guild", "guild_rank", "order", "order_rank") VALUES
  ...
  ('kazimira','kazimira','$2y$10$Om40QnY7ELgtedNugwwziOwVjn6mPDhFBQlXr1PR/h.w4Df0xBDZi','kazimira@localhost.k',1468051028,1479045690,NULL,NULL,12,FALSE,'blue-sky','female',FALSE,60,30,2,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL),
  ('bozena','bozena','$2y$10$Z7McIrRNP6pOt9xDfgp7/uPTjXO933l9ky/Ns9XEUsiu6YN0v2G4S','bozena@localhost.k',1495104741,1495104741,NULL,NULL,11,FALSE,'blue-sky','female',FALSE,60,30,3,1,NULL,NULL,0,NULL,NULL,NULL,NULL);
