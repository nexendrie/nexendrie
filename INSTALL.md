...
Requirements
------------
Obviously, you need PHP. Version 5.6 or later is required, but 7.0+ is highly recommended. Then you need web server (preferably Apache or Nginx) and sql server (MySql, PostgreSql, MariaDb, etc.).
