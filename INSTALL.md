...
Obviously, you need PHP. Version 7.3 or later is required. Then you need web server (Apache is a safe bet) and sql server (preferably MySql, MariaDb or PostgreSQL but MS SQL might be also used).
