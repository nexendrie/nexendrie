...
final class CastleTest extends \Tester\TestCase {
  ...
  protected Castle $model;
  
  protected function setUp(): void {
    $this->model = $this->getService(Castle::class); // @phpstan-ignore assign.propertyType
  }
  
  public function testListOfCastles(): void {
    $result = $this->model->listOfCastles();
    Assert::type(ICollection::class, $result);
    Assert::type(CastleEntity::class, $result->fetch());
  }
  
  public function testGetCastle(): void {
  ...
  public function testEditCastle(): void {
    Assert::exception(function() {
  ...
  public function testGetUserCastle(): void {
